...
export function secureUpload(options = {}) {
    ...
    return {
        ...
        handle: async (ctx, next) => {
            ...
            if (size > maxSizeBytes) {
                throw new ValidationError(`File exceeds maximum allowed size of ${maxSizeBytes / 1024 / 1024}MB`, [{ field: fieldName, message: 'File too large', code: 'file_too_large' }]);
            }
