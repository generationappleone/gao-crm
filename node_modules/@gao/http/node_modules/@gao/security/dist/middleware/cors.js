...
export function cors(options = {}) {
    ...
    const allowedHeadersStr = (Array.isArray(options.allowedHeaders)
    ...
    return {
        ...
        handle: async (ctx, next) => {
            ...
            const responseHeaders = (ctx.metadata.responseHeaders ??= {});
            if (!request) {
            ...
            if (options.origin === true || options.origin === undefined) {
                ...
                isAllowed = options.origin.some((o) => typeof o === 'string' ? o === origin : o instanceof RegExp ? o.test(origin) : false);
            }
