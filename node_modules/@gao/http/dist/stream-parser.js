 ...
 */
export async function parseJsonStream(request, maxSize = 1_048_576) {
 ...
 */
export async function parseFormStream(request, maxSize = 1_048_576) {
    const body = request.body;
    if (!body)
        return {};
    const reader = body.getReader();
 ...
 * Does NOT clone the request.
 */
export async function parseTextStream(request, maxSize = 1_048_576) {
    const body = request.body;
    if (!body)
        return '';
    const reader = body.getReader();
