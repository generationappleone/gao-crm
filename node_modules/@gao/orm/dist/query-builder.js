...
export class QueryBuilder {
    ...
    _limit;
    _offset;
    constructor(driver, dialect = 'postgres', tableName) {
        this.driver = driver;
    ...
    where(column, operatorOrValue, value) {
        if (value === undefined) {
            ...
            // Three-arg form: where('column', '=', value)
            if (value === null && (operatorOrValue === '=' || operatorOrValue === 'IS')) {
                this._wheres.push({ column, operator: 'IS', value: null, boolean: 'AND' });
            }
            else if (value === null && (operatorOrValue === '!=' || operatorOrValue === 'IS NOT')) {
    ...
    whereNotIn(column, values) {
        if (values.length === 0)
            return this; // NOT IN empty = no restriction
    ...
    whereRaw(sql, params = []) {
        this._wheres.push({ column: sql, operator: '=', value: params, boolean: 'AND', raw: true });
        return this;
    }
    ...
    having(column, operatorOrValue, value) {
        if (value === undefined) {
            ...
            this._havings.push({ column, operator: operatorOrValue, value });
        }
        return this;
    }
     ...
     */
    compileUpsert(data, conflictColumns, updateColumns) {
