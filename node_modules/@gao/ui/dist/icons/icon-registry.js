 ...
 */
export function registerIcon(name, data, category) {
    icons.set(name, data);
 ...
 */
export function registerIconSet(category, set) {
    for (const [name, data] of Object.entries(set)) {
        registerIcon(name, data, category);
    }
}
// ─── Stroke Width Map ────────────────────────────────────────
 ...
 * ```
 */
export function gaoIcon(name, options = {}) {
    ...
    // Build class list
    const classes = ['gao-icon', `gao-icon-${name}`];
    if (options.class)
        classes.push(options.class);
    if (options.spin)
        classes.push('gao-icon-spin');
    if (options.pulse)
        classes.push('gao-icon-pulse');
    // Build attributes
    const attrs = [
 ...
 * ```
 */
export function gaoIconSprite(names) {
    const symbols = [];
 ...
 */
export function gaoIconAnimationCSS() {
