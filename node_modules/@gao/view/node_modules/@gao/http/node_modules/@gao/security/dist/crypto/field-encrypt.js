...
import { decrypt, encrypt } from './aes256.js';
/**
...
export function Encrypted(options = {}) {
    ...
    return (target, propertyKey) => {
        ...
        const registry = prototype[ENCRYPTED_FIELDS_META_KEY];
...
export function encryptFields(entity, key) {
    ...
    for (const [field, options] of Object.entries(registry)) {
        ...
        if (options.searchable) {
            ...
            throw new Error('Searchable deterministic encryption is not yet implemented for the underlying AES service. Requires IV controls.');
        }
 ...
 */
export function decryptFields(entity, key) {
    const prototype = Object.getPrototypeOf(entity);
    const registry = prototype?.[ENCRYPTED_FIELDS_META_KEY];
    if (!registry)
        return entity; // Nothing to decrypt
    // biome-ignore lint/suspicious/noExplicitAny: Object spread drops exact type in standard library sometimes
    const result = Object.assign(Object.create(prototype), entity);
...
//# sourceMappingURL=field-encrypt.js.map