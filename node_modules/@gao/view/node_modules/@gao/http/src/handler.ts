...
export interface HttpHandlerOptions {
    ...
    container?: Container;
    /** Optional URL prefix prepended to all controller routes (e.g. '/gaocrm/admin-panel') */
    prefix?: string;
    /** Custom 404 handler — invoked when no route matches */
    onNotFound?: (req: GaoRequest, res: GaoResponse) => Response | Promise<Response>;
}
