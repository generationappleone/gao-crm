export const CreateJunctionTables = {
    ...
    async up(driver) {
        await driver.execute(`
            ...
            CREATE INDEX idx_contacts_tags_tag ON contacts_tags (tag_id);
            ...
            CREATE INDEX idx_deals_tags_tag ON deals_tags (tag_id);
        `);
    },
    async down(driver) {
...
//# sourceMappingURL=009_create_junction_tables.js.map