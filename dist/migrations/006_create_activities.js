export const CreateActivitiesTable = {
    ...
    async up(driver) {
        await driver.execute(`
            ...
            CREATE INDEX idx_activities_completed ON activities (is_completed) WHERE deleted_at IS NULL;
            CREATE INDEX idx_activities_due ON activities (due_at) WHERE deleted_at IS NULL AND is_completed = false;
