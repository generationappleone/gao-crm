...
export function paginationOffset(params) {
    return (params.page - 1) * params.perPage;
}
export function renderPaginationHtml(meta, baseUrl) {
    ...
    for (let i = 1; i <= meta.total_pages; i++) {
        ...
        pages.push(`<a href="${baseUrl}?page=${i}" style="display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:8px;${style}font-size:13px;font-weight:600;text-decoration:none;">${i}</a>`);
    }
    return `
