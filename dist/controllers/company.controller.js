...
let CompanyController = class CompanyController {
    ...
    async createForm(req, res) {
        ...
        return res.html(renderPage({ title: 'New Company', content, activePath: '/crm/contacts', user: user ? { name: user.name, role: user.role } : undefined }));
    }
    async detail(req, res) {
        ...
        return res.html(renderPage({ title: company.name, content, activePath: '/crm/contacts', user: user ? { name: user.name, role: user.role } : undefined }));
    }
    async editForm(req, res) {
        ...
        return res.html(renderPage({ title: `Edit — ${company.name}`, content, activePath: '/crm/contacts', user: user ? { name: user.name, role: user.role } : undefined }));
    }
};
__decorate([
    Get('/'),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Function, Function]),
    __metadata("design:returntype", Promise)
], CompanyController.prototype, "createForm", null);
__decorate([
    Get('/:id'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Function, Function]),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Function, Function]),
    __metadata("design:returntype", Promise)
], CompanyController.prototype, "editForm", null);
